...
public class JackTokenizer {
    ...
    public static final Character C_SYMBOL_CURLY_OPEN = '{';
    public static final Character C_SYMBOL_CURLY_CLOSE = '}';
    public static final Character C_SYMBOL_ROUND_OPEN = '(';
    public static final Character C_SYMBOL_ROUND_CLOSE = ')';
    public static final Character C_SYMBOL_SQUARE_OPEN  = '[';
    public static final Character C_SYMBOL_SQUARE_CLOSE = ']';
    public static final Character C_SYMBOL_PERIOD = '.';
    public static final Character C_SYMBOL_COMMA = ',';
    public static final Character C_SYMBOL_SEMICOLON = ';';
    public static final Character C_SYMBOL_PLUS = '+';
    public static final Character C_SYMBOL_MINUS = '-';
    public static final Character C_SYMBOL_ASTERISK = '*';
    public static final Character C_SYMBOL_SLASH = '/';
    public static final Character C_SYMBOL_AND = '&';
    public static final Character C_SYMBOL_OR = '|';
    public static final Character C_SYMBOL_LT = '<';
    public static final Character C_SYMBOL_GT = '>';
    public static final Character C_SYMBOL_EQ = '=';
    public static final Character C_SYMBOL_TILDE = '~';
...
//        return token;
    ...
    private void InitSymbols() {
        ...
        symbols.add(C_SYMBOL_CURLY_OPEN);
        symbols.add(C_SYMBOL_CURLY_CLOSE);
        symbols.add(C_SYMBOL_ROUND_OPEN);
        symbols.add(C_SYMBOL_ROUND_CLOSE);
        symbols.add(C_SYMBOL_SQUARE_OPEN);
        symbols.add(C_SYMBOL_SQUARE_CLOSE);
        symbols.add(C_SYMBOL_PERIOD);
        symbols.add(C_SYMBOL_COMMA);
        symbols.add(C_SYMBOL_SEMICOLON);
        symbols.add(C_SYMBOL_PLUS);
        symbols.add(C_SYMBOL_MINUS);
        symbols.add(C_SYMBOL_ASTERISK);
        symbols.add(C_SYMBOL_SLASH);
        symbols.add(C_SYMBOL_AND);
        symbols.add(C_SYMBOL_OR);
        symbols.add(C_SYMBOL_LT);
        symbols.add(C_SYMBOL_GT);
        symbols.add(C_SYMBOL_EQ);
        symbols.add(C_SYMBOL_TILDE);
    }
